...
contextBridge.exposeInMainWorld('api', {
  ...
  canvases: {
    list: (filter?: { project_id?: string, standalone?: boolean }) => ipcRenderer.invoke('canvases:list', filter),
    create: (data: { title?: string, project_id?: string }) => ipcRenderer.invoke('canvases:create', data),
    update: (data: { id: string, title?: string, project_id?: string | null }) => ipcRenderer.invoke('canvases:update', data),
    link: (data: { id: string, project_id: string }) => ipcRenderer.invoke('canvases:link', data),
    unlink: (id: string) => ipcRenderer.invoke('canvases:unlink', id),
    reorder: (data: { ids: string[] }) => ipcRenderer.invoke('canvases:reorder', data),
    move: (data: { ids: string[], folder_id: string | null }) => ipcRenderer.invoke('canvases:move', data),
    getContent: (id: string) => ipcRenderer.invoke('canvases:getContent', id),
    saveContent: (id: string, content: string) => ipcRenderer.invoke('canvases:saveContent', id, content),
    delete: (id: string) => ipcRenderer.invoke('canvases:delete', id),
  },
  canvasFolders: {
    list: () => ipcRenderer.invoke('canvasFolders:list'),
    create: (data: { name: string, parent_folder_id?: string | null }) => ipcRenderer.invoke('canvasFolders:create', data),
    rename: (data: { id: string, name: string }) => ipcRenderer.invoke('canvasFolders:rename', data),
    move: (data: { id: string, parent_folder_id: string | null }) => ipcRenderer.invoke('canvasFolders:move', data),
    reorder: (data: { ids: string[] }) => ipcRenderer.invoke('canvasFolders:reorder', data),
    delete: (id: string) => ipcRenderer.invoke('canvasFolders:delete', id),
  },
  recycle: {
