...
contextBridge.exposeInMainWorld('api', {
  ...
  notes: {
    ...
    move: (data: { ids: string[], folder_id: string | null }) => ipcRenderer.invoke('notes:move', data),
  ...
  folders: {
    ...
    create: (data: { name: string, parent_folder_id?: string | null }) => ipcRenderer.invoke('folders:create', data),
    rename: (data: { id: string, name: string }) => ipcRenderer.invoke('folders:rename', data),
    move: (data: { id: string, parent_folder_id: string | null }) => ipcRenderer.invoke('folders:move', data),
    reorder: (data: { ids: string[] }) => ipcRenderer.invoke('folders:reorder', data),
